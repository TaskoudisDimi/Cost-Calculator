...
<template>
  <div>
    <div class="flex items-center justify-between mb-5">
      <div>
        <h2 class="text-xl md:text-2xl font-bold text-gray-50">Κωδικοί</h2>
    ...
    <div v-if="store.credentials.length === 0"
      ...
      <p class="text-gray-400 font-medium">Δεν έχεις αποθηκεύσει κωδικούς ακόμα</p>
    ...
    <div v-if="showModal" class="fixed inset-0 bg-black/40 flex items-end sm:items-center justify-center z-50 px-4 pb-4 sm:pb-0">
      <div class="bg-gray-800 rounded-2xl shadow-xl w-full max-w-md p-6">
        ...
        <form @submit.prevent="submit" class="space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">Όνομα παρόχου / εφαρμογής *</label>
          ...
          <div>
            <label class="block text-sm font-medium text-gray-300 mb-1">URL πληρωμής</label>
